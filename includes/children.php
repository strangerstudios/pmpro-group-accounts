...
function pmprogroupacct_checkout_after_level_cost_child() {
	...
	<div class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_form_field pmpro_checkout-field-group_code', 'pmpro_checkout-field-group_code' ) ); ?>">
		...
		<div class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_form_fields-inline' ) ); ?>">
			...
			<input aria-label="<?php esc_html_e( 'Apply group code', 'paid-memberships-pro' ); ?>" type="button" name="pmprogroupacct_apply_group_code" id="pmprogroupacct_apply_group_code" value="<?php esc_attr_e('Apply Code', 'pmpro-group-accounts' );?>" class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_btn' ) ); ?>" />
		</div>
	</div>
	<?php
}
